...
boot:
    ...
    # set mstatus.MPP bits to Supervisor Mode
    ...
    # Load address of 'supervisor' into mepc CSR
    la      t0, supervisor
    csrw    mepc, t0
    ...
    li      t6, -1                 # All ones to cover full address space
    ...
    # leave machine mode and jump to supervisor code
    mret
