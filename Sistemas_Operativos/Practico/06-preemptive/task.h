...
#define QUANTUM 3    // maximum number of ticks to be used by a `RUNNING` task in a CPU burst
...
struct  task {
    ...
    uint64          cant_ticks_task     // cantidad de ticks que realizo la tarea en runneable.    
};
